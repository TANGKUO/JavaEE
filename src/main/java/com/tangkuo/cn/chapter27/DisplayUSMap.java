package com.tangkuo.cn.chapter27;

import javax.swing.*;

public class DisplayUSMap extends JApplet {
	private City[] vertices = { new City("Seattle", 75, 50), new City("San Francisco", 50, 210),
	...
	private int[][] edges = { { 0, 1 }, { 0, 3 }, { 0, 5 }, { 1, 0 }, { 1, 2 }, { 1, 3 }, { 2, 1 }, { 2, 3 }, { 2, 4 },
