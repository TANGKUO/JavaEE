package com.tangkuo.cn.chapter34;

import javax.swing.JOptionPane;
import javax.swing.JScrollPane;
import javax.swing.JTextArea;

import com.tangkuo.cn.chapter10.Loan;
...
public class JOptionPaneDemo {
	public static void main(String args[]) {
		...
		Object annualInterstRateObject = JOptionPane.showInputDialog(null, "Select annual interest rate:",
		...
		Object numberOfYearsObject = JOptionPane.showInputDialog(null, "Select number of years:", "JOptionPaneDemo",
		...
		String output = "Interest Rate: " + annualInterestRate + "%" + " Number of Years: " + numberOfYears
