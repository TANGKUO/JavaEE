...
public class ModifyTree extends JApplet {
	...
	private JComboBox jcboSelectionMode = new JComboBox(
			new String[] { "CONTIGUOUS_TREE_SELECTION", "DISCONTIGUOUS_TREE_SELECTION", "SINGLE_TREE_SELECTION" });
	...
	public ModifyTree() {
		...
		p2.add(new JScrollPane(jTree2 = new JTree(new DefaultTreeModel(root)))); // Same
																					// root
																					// as
																					// jTree1
