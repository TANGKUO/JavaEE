...
public class TablePropertiesDemo extends JApplet {
	...
	// Create a combo box
	private JComboBox jcboAutoResizeMode = new JComboBox(new String[] { "AUTO_RESIZE_OFF", "AUTO_RESIZE_LAST_COLUMN",
			"AUTO_RESIZE_SUBSEQUENT_COLUMNS", "AUTO_RESIZE_NEXT_COLUMN", "AUTO_RESIZE_ALL_COLUMNS" });
	...
	public TablePropertiesDemo() {
		...
		jspiRowMargin.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				jTable1.setRowMargin(((Integer) (jspiRowMargin.getValue())).intValue());
			}
		});
